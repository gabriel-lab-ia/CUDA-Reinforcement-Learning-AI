...
<img width="1200" height="675" alt="image" src="https://github.com/user-attachments/assets/c9f29935-efc7-48aa-900c-c50fbb4be4b8" />
...
uv run cuda-rl benchmark-campaign --configs \
  configs/benchmarks/formal_gae.yaml \
  configs/benchmarks/formal_ppo_loss.yaml \
  configs/benchmarks/formal_replay_buffer.yaml \
  configs/benchmarks/formal_dqn_cartpole.yaml \
...
No speedup or learning-performance result is published in the README until it
has been extracted from raw campaign artifacts generated by the benchmark
runner. Native CUDA GAE is marked unavailable unless a Python binding exists.
